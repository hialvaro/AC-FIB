...
void reference (unsigned int address)
{
    ...
    byte = address & 31; //Fem un AND amb 0x1F ja que els ultims 5 bits que indiquen el byte accedit.
    bloque_m = address/32; //Eliminem els 5 bits de menys pes
    linea_mc = bloque_m & 127; //Fem un AND del bloc amb 0x7F: 7 bits de menys pes del bloc que indiquen la linia de mc.
